...
tasks.register("buildAll") {
    ...
    doLast {
        println("Build complete! Available modules:")
        println("- Common: ✓")
        println("- Extensions: ✓ (JS, Python)")
        println("- Documentation: ✓")
        println("- Fabric: ✅ FIXED - Using Architectury Loom 1.13.457")
        println("  - FAPI: 0.136.0+1.21.8 ✓")
        println("  - Loom: Resolved with Architectury setup ✓")
        println("  - Platform JARs now build successfully!")
        println("- Forge: Ready for Architectury setup")
    }
}
