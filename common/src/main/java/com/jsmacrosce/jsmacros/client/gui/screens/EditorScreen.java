...
public class EditorScreen extends BaseScreen {
    ...
    //?} else {
    /*public static Identifier defaultFontResource = Identifier.fromNamespaceAndPath("jsmacrosce", "ubuntumono");
    *///?}
    ...
    public EditorScreen(Screen parent, @NotNull File file) {
        ...
        //?} else {
        /*defaultFontResource = Identifier.parse(JsMacrosClient.clientCore.config.getOptions(ClientConfigV2.class).editorFont);
        *///?}
